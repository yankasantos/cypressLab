describe('Input search test', () => {
    ...
    it('visit cypress website', () => {
        cy.visit('/guides/getting-started/writing-your-first-test#Step-1-Visit-a-page')        
    });
    
    it('find the content types', () => {
        cy.visit('/guides/getting-started/writing-your-first-test#Step-2-Query-for-an-element')
        cy.contains('type')              
    });

    it('should input search', () => {
        cy.visit('/api/commands/contains#Syntax')
